...
<html lang="en">
        ...
        <div id="mainContent">
            <div class="box">
                ...
                <div class="childContent">
                    <div class="leftContent content" style="border: 5px solid; border-image: linear-gradient(to left, rgba(255, 102, 102, 0.7), transparent) 1;">
                        <!-- Your left content here -->
                    </div>
                    <div class="rightContent content" style="border: 5px solid; border-image: linear-gradient(to left, rgba(255, 102, 102, 0.7), transparent) 1;">
  ...
  <script>
    function validatePasswords() {
      ...
      var renewPassword = document.querySelector(".renewPass").value;

      var passwordPattern = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/;

      if (!passwordPattern.test(newPassword)) {
        document.querySelector(".errline1").innerHTML =
          "Mật khẩu phải chứa ít nhất 8 ký tự <br>";
        document.querySelector(".errline2").innerHTML =
          "bao gồm ít nhất một chữ cái và một số.";

        return;
      }

      if (newPassword !== renewPassword) {
        document.querySelector(".errorRePass").textContent =
  ...
  toggleButton.addEventListener('click', function() {
    ...
    // Nếu menu đang ẩn, hiển thị nó; nếu không, ẩn nó
    if (isMenuOpen) {
