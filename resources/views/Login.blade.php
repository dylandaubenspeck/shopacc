    ...
    <section class="formLogin dark:bg-gray-900 relative">
        <div
            ...
            <div class="img-responsive-wrap">
                <img src="img/jett.png" alt="Character Image" class="character-image">
            </div>
            ...
            <div style="border: 2px solid; border-image: linear-gradient(to left, rgba(255, 102, 102, 0.7), transparent) 1;"
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-6 md:space-y-8 md:w-full lg:w-96 " action="#">
                        <div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#"
                                class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Quên
                                mật khẩu ?</a>
                        </div>
                        <button
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Bạn đã có tài khoản? <a href="Register.html"
